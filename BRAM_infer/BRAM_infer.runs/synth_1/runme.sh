...
HD_PWD='D:/MIMO_Testbench/BRAM_infer/BRAM_infer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mem_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mem_test.tcl
